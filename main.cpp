...
//////////////////////////
    ...
    Player hero_1("images/pers_x2.png", 250, 250, PL_TEXTURE_SIZE, PL_TEXTURE_SIZE, "WASD");
    Player hero_2("images/pers_x2.png", 1000, 750, PL_TEXTURE_SIZE, PL_TEXTURE_SIZE, "ARROWS");
    ...
    for (int i = 0; i < HEIGHT_MAP; i++)
        for (int j = 0; j < WIDTH_MAP; j++) {
            ...
            if (TileMap[i][j] == FIRE_CONST) map.setTextureRect(IntRect(4 * MAP_COMM_SIZE, 0,
                                                                   MAP_COMM_SIZE, MAP_COMM_SIZE));
            if (TileMap[i][j] == FBUFF_CONST) map.setTextureRect(IntRect(5 * MAP_COMM_SIZE, 0,
                                                                        MAP_COMM_SIZE, MAP_COMM_SIZE));
            if (TileMap[i][j] == SPDBUFF_CONST) map.setTextureRect(IntRect(6 * MAP_COMM_SIZE, 0,
                                                                        MAP_COMM_SIZE, MAP_COMM_SIZE));
